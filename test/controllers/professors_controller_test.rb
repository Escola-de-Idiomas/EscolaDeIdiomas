...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { cpf: @professor.cpf, disciplina: @professor.disciplina, email: @professor.email, nome: @professor.nome, senha: @professor.senha } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { cpf: @professor.cpf, disciplina: @professor.disciplina, email: @professor.email, nome: @professor.nome, senha: @professor.senha } }
